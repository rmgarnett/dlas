...
prior = @(sample) ...
        normlike([10 5], sample(1)) + ...
        normlike([1 1], sample(4)) + ...
        normlike([0 1], sample(5)) + ...
        normlike([20 2], sample(6)) + ...
        normlike([0 1], sample(7)) + ...
        normlike([0 1], sample(8));

likelihood_function = @(sample) ...
    -prior(sample) + ...
    -gp_fault(rewrap(hyperparameters, ...
                    [sample(1:5)'; sample(2:3)'; sample(6:end)']), ...
...
hyperparameters_sampled = rewrap(hyperparameters, ...
        [mean_sample(1:5)'; mean_sample(2:3)'; mean_sample(6: ...
        end)']);
...
for i = 1:num_samples
  hyperparameter_sample = rewrap(hyperparameters, ...
        [samples(1:5, i)'; samples(2:3, i)'; samples(6:end)']);
